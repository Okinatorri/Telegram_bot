...
from zbuton import admin_buton
...
async def make_changes_command(message: types.Message):
    ...
    await bot.send_message(message.from_user.id, 'Что нужно хозяин?', reply_markup=admin_buton.buton_case_admin)
